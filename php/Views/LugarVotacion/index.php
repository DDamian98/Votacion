...
$lsvotacion= Cargar::lugarvotacion();
        ...
        <main>
            ...
            <div class="recent-orders">
                <table id="example">
                    ...
                    <tbody>
                        <?php 
                        foreach($lsvotacion as $lugar)
                        {
                        ?>
                        <tr>
                            <td><?=$lugar['lv_distrito']?></td>
                            <td><?=$lugar['lv_lugar']?></td>
                            <td><?=$lugar['lv_lugar']?></td>
                            <td><?=$lugar['lv_cantmesas']?></td>
                            <td ><a href="mesa.php?id=<?=$lugar['lv_id']?>" class="">Ver</a></td>
                            <td></td>
                        </tr>
