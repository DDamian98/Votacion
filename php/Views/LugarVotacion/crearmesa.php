    ...
    <div class="container">
        ...
        <div class="activity-grid">
					...
					<div class="card-body">
						    ...
						    <div class ="name">Distrito</div>
						        <div class="value">
						            <div class="input-group">
						                <input class="input--style-5" type="text" name="p_distrito" id="p_distrito" value="<?=$lv['lv_distrito']?>"   class="string" readonly />
						            </div>
						        </div>
						</div>
                        <?php 
						...
						<div class="form-row">
						    <div class ="name">Codigo de Mesa</div>
						        <div class="value">
						            <div class="input-group">
						                <input class="input--style-5" type="text" name="m_codigo" id="m_codigo" placeholder=" "  autocomplete="off" class="string" autofocus />
						            </div>
						        </div>
						</div>
